...
var (
	brokerURL  = "broker.hivemq.com" // To be replaced by SPECTRE.py
	brokerPort = 1883  // To be replaced by SPECTRE.py
	topic      = "/commands/"      // To be replaced by SPECTRE.py
	botID      = "b76bfbe9-3ca2-47e4-81b1-bff5af0cc1d9"     // To be replaced by SPECTRE.py
	apiToken   = ""  // To be replaced by SPECTRE.py
